...
{
public:
	AsyncUdpClient(asio::io_context& io_context, asio::ip::udp::endpoint ep):io_context_(io_context), end_point_(ep),
	...
	void SendMessage(const std::string msg)
	{
		...
		socket_.async_send_to(asio::buffer(&(*str)[0], str->size()), end_point_, [p, str](const asio::error_code& ec,
